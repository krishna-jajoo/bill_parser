    ...
    messages = [
        {
            ...
            "content": (
                ...
                "If the fields include line-item or table-related data (like Description, Quantity, Unit Price, Tax, etc.),\n"
                "combine those into an `Item List` array where each item is a structured dictionary.\n\n"
